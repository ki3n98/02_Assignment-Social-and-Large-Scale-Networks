graph [
  comment "Three clique communities (nodes 0-4, 5-9, 10-14) connected by single bridge edges.
  Girvan-Newman will detect the bridges as highest-betweenness edges and remove them first.
  Use with: --components 3, --simulate_failures, --robustness_check"
  node [ id 0  label "0"  ]
  node [ id 1  label "1"  ]
  node [ id 2  label "2"  ]
  node [ id 3  label "3"  ]
